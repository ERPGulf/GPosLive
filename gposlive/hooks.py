...
app_name = "gposlive"
app_title = "GPosLive"
app_publisher = "ERPGulf forked from Youssef Restom"
app_description = "GPosLive"
...
# app_include_css = "/assets/gposlive/css/gposlive.css"
# app_include_js = "/assets/gposlive/js/gposlive.js"


app_include_js = [
    "gposlive.bundle.js",
]
app_include_css = "gposlive.bundle.css"



# include js, css files in header of web template
# web_include_css = "/assets/gposlive/css/gposlive.css"
# web_include_js = "/assets/gposlive/js/gposlive.js"
...
doctype_js = {
    "POS Profile": "gposlive/api/pos_profile.js",
    "Sales Invoice": "gposlive/api/invoice.js",
    "Company": "gposlive/api/company.js",
}
...
# get_website_user_home_page = "gposlive.utils.get_home_page"
...
# before_install = "gposlive.install.before_install"
# after_install = "gposlive.install.after_install"
# before_uninstall = "gposlive.uninstall.before_uninstall"
after_uninstall = "gposlive.uninstall.after_uninstall"

# Desk Notifications
# ------------------
# See frappe.core.notifications.get_notification_config

# notification_config = "gposlive.notifications.get_notification_config"
...
doc_events = {
    ...
    "Customer": {
        ...
        "after_insert": "gposlive.gposlive.api.customer.after_insert",
    },
}
...
# 	],
# 	"daily": [
# 		"gposlive.tasks.daily"
# 	],
# 	"hourly": [
# 		"gposlive.tasks.hourly"
# 	],
# 	"weekly": [
# 		"gposlive.tasks.weekly"
# 	]
# 	"monthly": [
# 		"gposlive.tasks.monthly"
# 	]
# }
...
# before_tests = "gposlive.install.before_tests"

# Overriding Methods
# ------------------------------
#
# override_whitelisted_methods = {
# 	"frappe.desk.doctype.event.event.get_events": "gposlive.event.get_events"
# }
#
...
# 	"Task": "gposlive.task.get_dashboard_data"
# }
        ...
        "filters": [
            [
                ...
                (
                    ...
                    "POS Profile-posa_gposlive_settings",
                    ...
                    "POS Profile-posa_gposlive_advance_settings",
                    ...
                    "POS Profile-gposlive_payments",
                    "POS Profile-posa_use_gposlive_payments",
