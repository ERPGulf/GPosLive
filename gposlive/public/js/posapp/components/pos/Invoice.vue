...
export default {
  ...
  methods: {
    async getReturnedItemNoteOptions() {
      try {
        const res = await frappe.call({
          method: "gposlive.gposlive.api.posapp.get_returned_item_note_options",
        });
    ...
    load_all_customers() {
      ...
      frappe.call({
        method: "gposlive.gposlive.api.posapp.get_customer_names",
        args: {
    ...
    get_shipping_rule_names() {
      const vm = this;
      frappe.call({
        method: "gposlive.gposlive.api.posapp.get_shipping_rule_names",
        callback: function (r) {
          if (r.message) {
    ...
    get_available_qty(item) {
      ...
      frappe.call({
        method: "gposlive.gposlive.api.posapp.get_stock_availability",
        args: {
    ...
    async cancel_invoice() {
      ...
      if (doc.name && this.pos_profile.posa_allow_delete) {
        await frappe.call({
          method: "gposlive.gposlive.api.posapp.delete_invoice",
    ...
    async get_invoice_from_order_doc() {
      ...
      if (this.invoice_doc.doctype == "Sales Order") {
        await frappe.call({
          method:
            "gposlive.gposlive.api.posapp.create_sales_invoice_from_order",
          args: {
    ...
    update_invoice(doc) {
      var vm = this;
      frappe.call({
        method: "gposlive.gposlive.api.posapp.update_invoice",
        args: {
          data: doc,
        },
        async: false,
    ...
    update_invoice_from_order(doc) {
      var vm = this;
      frappe.call({
        method: "gposlive.gposlive.api.posapp.update_invoice_from_order",
        args: {
          data: doc,
        },
        async: false,
    ...
    async show_payment() {
      ...
      if (this.invoice_doc.doctype == "Sales Order") {
        ...
        frappe.call({
          method:
            "gposlive.gposlive.api.posapp.get_sales_invoice_child_table",
          args: {
    ...
    get_draft_invoices() {
      var vm = this;
      frappe.call({
        method: "gposlive.gposlive.api.posapp.get_draft_invoices",
        args: {
    ...
    get_draft_orders() {
      var vm = this;
      frappe.call({
        method: "gposlive.gposlive.api.posapp.search_orders",
        args: {
    ...
    update_items_details(items) {
      ...
      frappe.call({
        method: "gposlive.gposlive.api.posapp.get_items_details",
        async: false,
        args: {
          pos_profile: vm.pos_profile,
          items_data: items,
    ...
    update_item_detail(item) {
      ...
      var vm = this;
      frappe.call({
        method: "gposlive.gposlive.api.posapp.get_item_detail",
        args: {
    ...
    set_delivery_charges() {
      ...
      frappe.call({
        method:
          "gposlive.gposlive.api.posapp.get_applicable_delivery_charges",
        args: {
          company: this.pos_profile.company,
          pos_profile: this.pos_profile.name,
          customer: this.customer,
