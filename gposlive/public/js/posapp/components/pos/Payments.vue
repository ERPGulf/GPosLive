...
export default {
  ...
  methods: {
    ...
    async fetchShippingCharge() {
      ...
      const res = await frappe.call({
        method: "gposlive.gposlive.api.posapp.get_shipping_charge",
        args: {
  ...
  credit_card_payment() {
    ...
    submit_invoice(print) {
      ...
      const vm = this;
      frappe.call({
        method: "gposlive.gposlive.api.posapp.submit_invoice",
        args: {
          data: data,
    ...
    get_available_credit(e) {
      ...
      if (e) {
        frappe
          .call("gposlive.gposlive.api.posapp.get_available_credit", {
    ...
    get_addresses() {
      ...
      frappe.call({
        method: "gposlive.gposlive.api.posapp.get_customer_addresses",
    ...
    get_sales_person_names() {
      ...
      frappe.call({
        method: "gposlive.gposlive.api.posapp.get_sales_person_names",
        callback: function (r) {
          if (r.message) {
    ...
    request_payment() {
      ...
      frappe
        ...
        .then(() => {
          frappe
            .call({
              method: "gposlive.gposlive.api.posapp.create_payment_request",
              args: {
                doc: vm.invoice_doc,
              },
            })
    ...
    get_mpesa_modes() {
      const vm = this;
      frappe.call({
        method: "gposlive.gposlive.api.m_pesa.get_mpesa_mode_of_payment",
  ...
  mounted: function () {
    ...
    this.$nextTick(function () {
      this.eventBus.on("send_invoice_doc_payment", (invoice_doc) => {
        ...
        frappe.call({
          method: "gposlive.gposlive.api.posapp.get_default_sales_person",
          callback: (r) => {
            if (r.message) {
