...
export default {
  ...
  methods: {
    check_opening_entry() {
      var vm = this;
      return frappe
        .call("gposlive.gposlive.api.posapp.check_opening_shift", {
    ...
    get_available_pos_profiles() {
      ...
      return frappe
        .call("gposlive.gposlive.api.payment_entry.get_available_pos_profiles", {
    ...
    fetch_customer_details() {
      ...
      if (this.customer_name) {
        frappe.call({
          method: "gposlive.gposlive.api.posapp.get_customer_info",
          args: {
    ...
    get_outstanding_invoices() {
      ...
      return frappe
        .call("gposlive.gposlive.api.payment_entry.get_outstanding_invoices", {
    ...
    get_unallocated_payments() {
      ...
      return frappe
        .call("gposlive.gposlive.api.payment_entry.get_unallocated_payments", {
          customer: this.customer_name,
          company: this.company,
          currency: this.pos_profile.currency,
        })
    ...
    get_draft_mpesa_payments_register() {
      ...
      return frappe
        .call("gposlive.gposlive.api.m_pesa.get_mpesa_draft_payments", {
          company: vm.company,
    ...
    submit() {
      ...
      frappe.call({
        method: "gposlive.gposlive.api.payment_entry.process_pos_payment",
        args: { payload },
        freeze: true,
